...
public class TileObject2 
{
	...
	public Array<Body> ArrayOfBodies; // to delete them in level2 / Array contain all object of level 1
	public Array<Level1Bodies>coinArray; //hold all coins
	public Array<Level1Bodies>punchBagsArray; //hold all punch bags

	public TileObject2(Level2 level2,PlayScreen screen2) // constructor 
	{
