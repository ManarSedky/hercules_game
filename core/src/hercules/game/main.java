...
public class main extends Game // parent => game (buildin in libgdx )
{
	//Virtual Screen size and Box2D Scale(Pixels Per Meter) // m2asat 
	...
	// collision 
	public static final short GROUND_BIT = 1; // 2 power x
	...
	public SpriteBatch batch; // brsm 3lih
	...
	{ // intializa class 
		...
		// this => main ßÊÈÊ  ÒíÓ ÚÔÇä äİÓ ÇáßáÇÓ 
	}
